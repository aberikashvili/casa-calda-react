...
export function NavBar({ display }: any) {
  ...
  return (
    ...
    >
      <li
        className={`${
          location.pathname === "/" && "text-blueText-rgba font-demi"
      ...
      <li
        className={`${
          location.pathname === "/aboutUs" && "text-blueText-rgba font-demi"
        } text-center`}
      >
      ...
      <li
        className={`${
          location.pathname === "/partners" && "text-blueText-rgba font-demi"
        } text-center`}
      >
      ...
      <li
        className={`${
          location.pathname === "/projects" && "text-blueText-rgba font-demi"
        } text-center`}
      >
      ...
      <li
        className={`${
          location.pathname === "/OurWork/*" && "text-blueText-rgba font-demi"
        } text-center`}
      >
      ...
      <li
        className={`${
          location.pathname === "/employees" && "text-blueText-rgba font-demi"
        } lgg:hidden text-center lg1:flex`}
      >
